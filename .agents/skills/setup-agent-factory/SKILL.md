...
description: Configure a Git repository to use the portable Agent Factory skills. Use when a human explicitly asks to initialize or update the repository's project contract, verification commands, forge settings, and QA instructions.
---
...
Create or update `.agent-factory/project.md` without overwriting project-specific guidance. Work journals live under the Git common directory and require no repository ignore rule. Do not ignore `project.md`.
