...
Read [rubric.md](references/rubric.md). Review the exact construction SHA using commit-addressed Git operations so concurrent test changes cannot alter the target.
